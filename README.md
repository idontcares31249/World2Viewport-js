...
- `vpParams` - viewport width and height and also sizing (see below)
...
I specifically made the code as *apprehensible* as possible and added lots of comments. In total, there are 146 lines of code, 1 private function besides the 4 public ones.
